package cn.hujw.developkits.CustomView;
...
public abstract class LoadPage extends FrameLayout {
    ...
    private void initView() {
        if(loadingPage==null){
            ...
            this.addView(loadingPage, new LayoutParams
                    (LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        }
        if(errorPage==null){
            errorPage=createView(R.layout.loadpage_error);
            this.addView(errorPage, new LayoutParams
                    (LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
            reStartLoad= (Button) errorPage.findViewById(R.id.btn_restartLoad);
            reStartLoad.setOnClickListener(new OnClickListener() {
                @Override
        ...
        if(emptyPage==null){
            ...
            this.addView(emptyPage, new LayoutParams
                    (LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        }
        showPage();
    }
